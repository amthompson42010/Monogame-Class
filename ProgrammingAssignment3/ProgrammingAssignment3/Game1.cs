...
namespace ProgrammingAssignment3
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            firstRock = Content.Load<Texture2D>("greenrock");
            secondRock = Content.Load<Texture2D>("magentarock");
            thirdRock = Content.Load<Texture2D>("whiterock");

            // STUDENTS: Create a new random rock by calling teh GetRandomRock method
            Rock randomRock = GetRandomRock();
        }
